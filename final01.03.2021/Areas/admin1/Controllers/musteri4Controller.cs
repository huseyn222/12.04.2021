...
{
    public class musteri4Controller : Controller
    {
        ...
        // GET: admin1/musteri4/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: admin1/musteri4/Create
